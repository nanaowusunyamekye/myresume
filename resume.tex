...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Nana Owusu}{Nyamekye}
%%%\address{Akbar Road, Block D, House 93, Bashundhara R/A, Dhaka-1229}
\mobile{(+233) 55-972-8253 } 
%%% Social
\email{nanaowusu1234@gmail.com}
%\homepage{www.posquit0.com}
\github{nanaowusunyamekye}
\linkedin{nanaowusunyamekye}
%%% Optionals
%\position{Applications Developer}
%\quote{``Unless you do something other than that which you already know, you will never grow"}
